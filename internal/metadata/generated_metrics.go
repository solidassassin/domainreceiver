...
var MetricsInfo = metricsInfo{
	DomainExpiryTime: metricInfo{
		Name: "domain.expiry.time",
	},
}
...
type metricDomainExpiryTime struct {
	data     pmetric.Metric // data buffer for generated metric.
	config   MetricConfig   // metric config provided by user.
	capacity int            // max observed number of data points added to the metric.
}

// init fills domain.expiry.time metric with initial data.
func (m *metricDomainExpiryTime) init() {
	m.data.SetName("domain.expiry.time")
...
func (m *metricDomainExpiryTime) updateCapacity() {
...
func (m *metricDomainExpiryTime) emit(metrics pmetric.MetricSlice) {
...
func newMetricDomainExpiryTime(cfg MetricConfig) metricDomainExpiryTime {
	m := metricDomainExpiryTime{config: cfg}
...
func (mb *MetricsBuilder) EmitForResource(options ...ResourceMetricsOption) {
	...
	mb.metricDomainExpiryTime.emit(ils.Metrics())
